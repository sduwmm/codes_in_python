...
Modified on Mon Apr 9 09:51:23 2019
    ...
    for ii in loopEner:
        ...
        for jj in loopTheta:
            ...
            for kk in loopPhi:
                ...
                nByVxTT  += deltaTheta*deltaPhi*velIICube*velDelII*(-1)*(math.sin(thetaJJ))**2*math.cos(phiKK)*distTT[ii,jj,kk]###multiply -1
                nByVyTT  += deltaTheta*deltaPhi*velIICube*velDelII*(-1)*(math.sin(thetaJJ))**2*math.sin(phiKK)*distTT[ii,jj,kk]###multiply -1
                nByVzTT  += deltaTheta*deltaPhi*velIICube*velDelII*(-1)*math.sin(thetaJJ)*math.cos(thetaJJ)*distTT[ii,jj,kk]###multiply -1
...
ax3.plot(epochToPlot, vxKMS, 'b')
ax3.plot(epochToPlot, vyKMS, 'g')
ax3.plot(epochToPlot, vzKMS, 'r')
