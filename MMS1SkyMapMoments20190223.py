...
def MagneticPressure(Time, FileMag):
    ...
    bGSEVec=FileMag.varget('mms1_fgm_b_gse_brst_l2')
    #
    EpochToCalculateType2000=cdflib.cdfepoch.compute_tt2000(Time)
    EpochIndTpl=np.where(EpochData>=EpochToCalculateType2000)
    EpochIndArr=EpochIndTpl[0]
...
###======================================================================
FileInput = \
    cdflib.CDF('D:/data/mms/mms1/fpi/brst/l2/dis-dist/2019/02/23/mms1_fpi_brst_l2_dis-dist_20190223052123_v3.3.0.cdf')
FileMagInput = \
    cdflib.CDF('D:\\data\\mms\\mms1\\fgm\\brst\\l2\\2019\\02\\23\\mms1_fgm_brst_l2_20190223052123_v5.180.0.cdf')
FigurePathInput = 'D:/OneDrive - mail.sdu.edu.cn/work/code&figure/figure2021/skyMap/'
###=======================================================
PhiInput=[0,1,28,29,30,31]
ThetaInput=[]
#momFore = MomentsNo(TimeInput, FileInput, PhiInput, ThetaInput)
###test
#TimeInput=[2019,2,23,5,22,4,0]
#TimeInput=[2019,2,23,5,22,6,500]
#TimeInput=[2019,2,23,5,22,9,000]
#TimeInput=[2019,2,23,5,22,10,800]
#TimeInput=[2019,2,23,5,22,12,0]
#TimeInput=[2019,2,23,5,22,13,400]###Discontinuity
#TimeInput=[2019,2,23,5,22,14,500]###Discontinuity
#TimeInput=[2019,2,23,5,22,15,0]###Discontinuity
#TimeInput=[2019,2,23,5,22,18,0]
TimeInput=[2019,2,23,5,22,20,0]
...
###根据前面输入的角度范围修改
Normal=[0,0,0]
#NormalInner1=[0.82360789,-0.46287034,0.32775158]#10-13.700
#NormalInner2=[0.88136447,-0.33967964,0.32835106]#14.100-14.550
#NormalOuter = [0.89315620, 0.079792350, 0.44261177]#14.800-15.300
