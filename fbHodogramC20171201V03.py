...
Modified on Sun Apr 26 19:03:00 2020
...
Version 0
case 20171201_
Modified version3: plot the direction of magnetic field in the MVA basis
'''
...
ax1.plot(epochToCal, bLMN[:, 2], linewidth=0.8, color=colors[2], label=labelsLMN[2])
...
ax0.set_xticklabels(strTick, fontsize=10)
ax1.set_xlim(xlim)
ax1.set_ylim([-35, 35])
...
ax1.set_xlabel('14:41:00 ----->14:41:01', fontsize = 15)
'''
'''
timeStartHodo = [2017, 12, 1, 14, 41, 3, 100]
timeStopHodo  = [2017, 12, 1, 14, 41, 3, 400]
ax1.set_xlabel('14:41:03.1 ---->14:41:03.4', fontsize = 15)

'''
timeStartHodo = [2017, 12, 1, 14, 40, 55, 000]
timeStopHodo  = [2017, 12, 1, 14, 41, 0,  000]
ax1.set_xlabel('14:40:55 ----->14:41:00', fontsize = 15)
...
bNHodoMean = np.mean(bNHodo)
bMHodoMean = np.mean(bMHodo)
bLHodoMean = np.mean(bLHodo)
...
ax3.scatter(bLHodo[0], bMHodo[0], marker='*', linewidth = 4,color='steelblue')
#ax3.scatter(bLHodo[bLHodo.size - 1], bMHodo[bMHodo.size - 1], marker='s', linewidth = 4, color='steelblue')
ax3.set_xlabel('$B_{L}$')
ax3.set_ylabel('$B_{M}$')
ax3.scatter(bLHodoMean, bMHodoMean, marker = 'x',linewidth = 3, color = 'black')
ax3.set_xlim([-35, 15])
ax3.set_ylim([-30, 20])
ax4.plot(bNHodo, bMHodo, color='darkorange')
ax4.scatter(bNHodo[0], bMHodo[0], marker='*', linewidth=4, color='darkorange')
#ax4.scatter(bNHodo[bMHodo.size - 1], bMHodo[bMHodo.size - 1], marker='s', linewidth=4, color='darkorange')
ax4.set_xlabel('$B_{N}$')
#ax4.set_ylabel('$B_{M}$')
ax4.set_xlim([-35, 15])
ax4.set_ylim([-30, 20])
...
#plt.savefig(figurePath + '\\hodogramShock.png', dpi=200)
plt.savefig(figurePath + '\\hodogramShock.png', dpi =200)
plt.show()
