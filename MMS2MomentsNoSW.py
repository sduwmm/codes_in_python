...
def MomentsNoSW(Time, FileDist, Theta, Phi):
    ###constants==================
    mp = 1.67262158 * 10 ** (-27)
...
ThetaNoInput = [0,1,2,3,10,11,12,13,14,15]#np.arange(3, 10, 1)
PhiNoInput = np.arange(3, 29, 1)
moments = MomentsNoSW(TimeInput, FileDistInput, ThetaNoInput,PhiNoInput)
print(time.time())
