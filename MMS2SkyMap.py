...
def PlotSkyMap(Time, FileDist, EnergyChannel, FigurePath):
    ...
    FigureName = FigurePath + 'MMS2_' + str(Time[0]) + str(Time[1]) + str(Time[2]) + \
    ...
    return()
###========================================
#TimeInput = [2019, 2, 23, 5, 22, 5, 771]
TimeInput = [2019, 2, 23, 5, 22, 7, 871]
#TimeInput = [2019, 2, 23, 5, 22, 10,422]
