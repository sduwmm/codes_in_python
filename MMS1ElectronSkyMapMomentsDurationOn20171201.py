...
DenMom = FileMom.varget('mms1_des_numberdensity_brst')
DenErrMom = FileMom.varget('mms1_des_numberdensity_err_brst')
#BulkvDBCSMom = FileMom.varget('mms1_des_bulkv_dbcs_brst')####'mms1_des_bulkv_spintone_dbcs_brst'
TempParaMom = FileMom.varget('mms1_des_temppara_brst')
TempPerpMom = FileMom.varget('mms1_des_tempperp_brst')
EnerSpecMom = FileMom.varget('mms1_des_energyspectr_omni_brst')
