...
Modified on Thur Apr 4 10:58:40 2019
...
for tt in timeArrToCal:
    ...
    for ii in loopEner:
        ...
        for jj in loopTheta:
            thetaJJ = math.pi - thetaTT[jj]
            for kk in loopPhi:
                phiKK    =  phiTT[kk] - math.pi
...
ax1.plot(epochToPlot, densityCM, 'darkorange')
ax1.plot(epochMomToPlot, denToPlot, 'deepskyblue')
ax1.set_ylabel('Density', fontsize = 15)
#ax1.set_ylim([0,20])
#ax1.set_xlim(xlim1)
ax1.set_title('Moments VS Official Moments', fontsize = 20)

ax2.plot(epochToPlot, vxKMS*(1), 'darkorange')
ax2.plot(epochMomToPlot, vxToPlot, 'deepskyblue')
ax2.set_ylabel('Vx', fontsize =15)
#ax2.set_xlim(xlim1)
#ax3.set_ylim([-600, 200])

ax3.plot(epochToPlot, vyKMS*(1), 'darkorange')
ax3.plot(epochToPlot, vyToPlot, 'deepskyblue')
ax3.set_ylabel('Vy', fontsize = 15)
#ax3.set_xlim(xlim1)
#ax3.set_ylim([0,600])

ax4.plot(epochToPlot, vzKMS*(1), 'darkorange')
ax4.plot(epochMomToPlot, vzToPlot, 'deepskyblue')
ax4.set_ylabel('Vz', fontsize = 15)

ax5.plot(epochToPlot, vtotalKMS, 'darkorange')
ax5.plot(epochMomToPlot, vtotalToPlot, 'deepskyblue')
ax5.set_ylabel('Vtotal', fontsize = 15)

ax6.plot(epochToPlot, pthnPa, 'darkorange')
ax6.plot(epochMomToPlot, pthToPlotnPa, 'deepskyblue')
...
plt.savefig('D:/shfaFigure/20171116121300/momentsVS.png')
plt.show()
